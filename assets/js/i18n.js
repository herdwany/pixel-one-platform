...
const TRANSLATIONS = {
  fr: {
    ...
    'admin.blog.content.label': 'Contenu (éditeur riche HTML)',
    ...
    'blog.back.all':       'Voir tous les articles',
    'blog.share':          'Partager',
    'blog.copylink':       'Copier le lien',
    'blog.comments':       'Commentaires',
    'blog.comments.loading':'Chargement des commentaires\u2026',
    'blog.comments.empty': 'Aucun commentaire pour le moment.',
    'blog.comment.add':    'Laisser un commentaire',
    'blog.comment.name':   'Nom',
    'blog.comment.email':  'Email',
    'blog.comment.rating': 'Note',
    'blog.comment.message':'Commentaire',
    'blog.comment.submit': 'Envoyer',
    'blog.comment.success':'Commentaire envoy\u00e9 ! En attente d\u2019approbation.',
    'blog.comment.admin_reply':'R\u00e9ponse de Pixel One',
    'blog.related':        'Vous aimerez aussi',
    'blog.related.empty':  'Pas d\u2019autres articles pour le moment.',
  ...
  en: {
    ...
    'admin.blog.content.label': 'Content (Rich HTML editor)',
    ...
    'blog.back.all':       'See all articles',
    'blog.share':          'Share',
    'blog.copylink':       'Copy link',
    'blog.comments':       'Comments',
    'blog.comments.loading':'Loading comments\u2026',
    'blog.comments.empty': 'No comments yet.',
    'blog.comment.add':    'Leave a comment',
    'blog.comment.name':   'Name',
    'blog.comment.email':  'Email',
    'blog.comment.rating': 'Rating',
    'blog.comment.message':'Comment',
    'blog.comment.submit': 'Submit',
    'blog.comment.success':'Comment submitted! Pending admin approval.',
    'blog.comment.admin_reply':'Reply from Pixel One',
    'blog.related':        'You might also like',
    'blog.related.empty':  'No other articles yet.',
  ...
  ar: {
    ...
    'admin.blog.content.label': 'المحتوى (محرر HTML احترافي)',
    ...
    'blog.back.all':       'عرض جميع المقالات',
    'blog.share':          'مشاركة',
    'blog.copylink':       'نسخ الرابط',
    'blog.comments':       'التعليقات',
    'blog.comments.loading':'جارٍ تحميل التعليقات…',
    'blog.comments.empty': 'لا توجد تعليقات حالياً.',
    'blog.comment.add':    'اترك تعليقاً',
    'blog.comment.name':   'الاسم',
    'blog.comment.email':  'البريد الإلكتروني',
    'blog.comment.rating': 'التقييم',
    'blog.comment.message':'التعليق',
    'blog.comment.submit': 'إرسال',
    'blog.comment.success':'تم إرسال التعليق! بانتظار موافقة الإدارة.',
    'blog.comment.admin_reply':'رد بيكسل ون',
    'blog.related':        'قد يعجبك أيضاً',
    'blog.related.empty':  'لا توجد مقالات أخرى حالياً.',
